...
class Producto extends EntidadBase{
    ...
    public function save(){
        ...
        (prod_id,prod_nombre,prod_precioc,prod_stock,prod_stockmin,prod_stockmax,
        prod_codigobarras,prod_codigoprod,prod_costopromedio,prod_precio1,
        prod_precio2,prod_precio3,prod_precio4,prod_costolifo,prod_costofifo,prod_fecha)
                VALUES(NULL,'".$this->prod_nombre."',
                    '".$this->prod_precioc."',
                    '".$this->prod_stock."',
                    '".$this->prod_stockmin."',
                    '".$this->prod_stockmax."',
                    '".$this->prod_codigobarras."',
                    '".$this->prod_codigoprod."',
                    '".$this->prod_costopromedio."',
                    '".$this->prod_precio1."',
                    '".$this->prod_precio2."',
                    '".$this->prod_precio3."',
                    '".$this->prod_precio4."',
                    '".$this->prod_costolifo."',
                    '".$this->prod_costofifo."',(SELECT now()));";
